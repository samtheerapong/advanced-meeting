    ...
    public function actionCreate()
    {
        ...
        if ($this->request->isPost) {
            if ($model->load(Yii::$app->request->post()) && $user->load(Yii::$app->request->post())) {
                $user->password_hash = Yii::$app->security->generatePasswordHash($user->password_hash); // สร้าง Password hash
                $user->auth_key = Yii::$app->Security->generateRandomString(); // สร้าง RandomString
